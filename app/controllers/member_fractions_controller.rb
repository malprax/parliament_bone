  ...
  def create
    ...
    respond_to do |format|
      if @member_fraction.save
        format.html { redirect_to @member_fraction, notice: 'Member fraction was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @member_fraction.update(member_fraction_params)
        format.html { redirect_to @member_fraction, notice: 'Member fraction was successfully updated.' }
