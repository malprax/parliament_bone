...
Parliament.create(name: 'Samasuddin Alfian Kalla, S.Ip', tempat_lahir: 'Panjalili', tanggal_lahir: '1 Februari 1975', fraksi: 'Keadilan Persatuan', komisi: 'I', jabatan_komisi: 'Anggota')
